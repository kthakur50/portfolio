...
function initMasonry() {
  ...
  const projects = [
    {
      ...
      desc:  'AI-driven expense tracking that categorizes spending, predicts trends and surfaces smart budget insights.',
  ...
  projects.forEach((p, i) => {
    ...
    // Click-guard for placeholder links only.
  });
