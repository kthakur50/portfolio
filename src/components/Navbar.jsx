      ...
      <a className="nav-logo" href="#home">
        <span className="nav-logo-mark" aria-hidden="true">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round">
            <path d="M4 12c2-4 6-7 11-7 3 0 5.5 2 5.5 4.5S18 14 15 14c-3.5 0-6-2.3-7.5-4.8"/>
            <path d="M4 12c2 4 6 7 11 7 3 0 5.5-2 5.5-4.5"/>
            <circle cx="16.2" cy="9" r=".6" fill="currentColor" stroke="none"/>
            <path d="M6 12c-1.2.5-2.4.5-3.6 0"/>
          </svg>
        </span>
        <span className="nav-logo-text">Kaushal Thakur</span>
      </a>
