    ...
    <div className="nav-inner" id="navInner">
      ...
      <div className="nav-top">
        ...
        <div className="nav-center" id="navCenter">
          {/* Desktop: icons + labels sit hidden by default, centered in the
              navbar — clicking the search icon expands the navbar in place
              and reveals them together, centered, with a tooltip name on
              each icon. */}
          <div className="nav-desk-links" id="navDeskLinks">
            <a href="#home" className="nd-link" data-label="home" aria-label="Home">
              ...
              <span className="nd-label">Home</span>
            </a>
            <a href="#about" className="nd-link" data-label="about" aria-label="About">
            ...
            <a href="#skills" className="nd-link" data-label="skills" aria-label="Skills">
              ...
              <span className="nd-label">Skills</span>
            </a>
            <a href="#experience" className="nd-link" data-label="experience" aria-label="Experience">
              ...
              <span className="nd-label">Experience</span>
            </a>
            <a href="#projects" className="nd-link" data-label="projects" aria-label="Projects">
            ...
            <a href="#education" className="nd-link" data-label="education" aria-label="Education">
            ...
            <a href="#contact" className="nd-link" data-label="contact" aria-label="Contact">
              ...
              <span className="nd-label">Contact</span>
            </a>
          </div>
        </div>
        ...
        <div className="nav-right" id="navLinks">
          <button className="nav-ham" id="ham" aria-label="Search sections">
            ...
            <span className="nav-ham-label">Search</span>
          </button>
        </div>
      </div>
    </div>
