    ...
    <section id="contact">
      <div className="wrap">
        ...
        <div className="contact-card sr" style={{ transitionDelay: '.05s' }}>
          <p className="contact-lead">Open to new projects, freelance work, and full-time roles in web development and GenAI engineering. Reach out anytime — I usually reply within a day.</p>

          <div className="contact-links">
            <a href="mailto:kthakur0578@gmail.com" className="btn-o btn-o--em">
            ...
            <a href="https://linkedin.com/in/kaushalt18" target="_blank" rel="noopener" className="btn-o btn-o--li">
              <span className="btn-o-ico">
            ...
            <a href="https://github.com/kaushalt18" target="_blank" rel="noopener" className="btn-o btn-o--gh">
              <span className="btn-o-ico">
