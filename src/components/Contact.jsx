    ...
    <section id="contact">
      <div className="wrap">
        ...
        <div className="contact-card sr" style={{ transitionDelay: '.05s' }}>
          <p className="contact-lead">Interested in working together? I'd love to hear about your project.</p>

          <a href="mailto:kthakur0578@gmail.com" className="contact-email">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/>
            </svg>
            kthakur0578@gmail.com
            <span className="contact-email-arr" aria-hidden="true">→</span>
          </a>

          <div className="contact-socials">
            <a href="https://linkedin.com/in/kaushalt18" target="_blank" rel="noopener" className="contact-social" aria-label="LinkedIn">
            ...
            <a href="https://github.com/kaushalt18" target="_blank" rel="noopener" className="contact-social" aria-label="GitHub">
