  ...
  <section id="home">
    ...
    <div className="wrap">
      ...
      <div className="hero-social-row" style={{ transitionDelay: '.08s' }}>
        <a href="https://github.com/kaushalt18" target="_blank" rel="noopener" aria-label="GitHub" className="hero-social-ico hero-social-gh">
        ...
        <a href="https://linkedin.com/in/kaushalt18" target="_blank" rel="noopener" aria-label="LinkedIn" className="hero-social-ico hero-social-li">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
        ...
        <a href="https://x.com/kaushalt18" target="_blank" rel="noopener" aria-label="X" className="hero-social-ico hero-social-x">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
            <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
          </svg>
        </a>
        <a href="#" aria-label="Resume" className="hero-social-ico hero-social-resume">
        ...
        <a href="mailto:kthakur0578@gmail.com" aria-label="Email" className="hero-social-ico hero-social-mail">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
